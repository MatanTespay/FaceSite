...
<body>
		...
		<div id="header">
			...
			<div class="Home_Class">
				<a href="mainPage.jsp"> <img src="Pics/home.png" id="home">
					...
					href='MainProfile.jsp?user=<%=session.getAttribute("userid")%>&catagory=Others'>
					<img src="Pics/profileLogo.png" id="profileLogo">
				</a>
			</div>
			<div class="Msg_Class">
	...
	<%
		if (request.getParameter("id") != null) {
			String newPostID = request.getParameter("id");
	%>

	<script type="text/javascript">
		var newPostID = "<%= newPostID %>";
		var divID = "post_" + newPostID;
		
		$(document).ready(function(){
			$('#'+divID).effect( "highlight", {color:"#ffff99"}, 3000 );
